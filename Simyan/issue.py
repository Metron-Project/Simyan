...
class Issue:
    ...
    Attributes:
        ...
        character_deaths (list of :obj: `GenericEntry`): List of characters who died in the Issue.
        characters (list of :obj: `GenericEntry`): List of characters in the Issue.
        concepts (list of :obj: `GenericEntry`): List of concepts in the Issue.
        cover_date (date): Date on the cover of the Issue.
        creators (list of :obj: `GenericEntry`): List of creators which worked on the Issue.
        ...
        first_appearance_characters (Optional, list of :obj: `GenericEntry`):
            List of characters who first appear in the Issue.
        first_appearance_concepts (Optional, list of :obj: `GenericEntry`):
            List of concepts which first appear in the Issue.
        first_appearance_locations (Optional, list of :obj: `GenericEntry`):
            List of locations which first appear in the Issue.
        first_appearance_objects (Optional, list of :obj: `GenericEntry`):
            List of objects which first appear in the Issue.
        first_appearance_story_arcs (Optional, list of :obj: `GenericEntry`):
            List of story arcs which start in the Issue.
        first_appearance_teams (Optional, list of :obj: `GenericEntry`):
        ...
        locations (list of :obj: `GenericEntry`): List of locations which appear in the Issue.
        name (str): Name/Title of the Issue.
        number (str): The Issue number.
        objects (list of :obj: `GenericEntry`): List of objects which appear in the Issue.
        site_url (str): Url to the ComicVine Website.
        store_date (date, Optional): Date the Issue went on sale on stores.
        story_arcs (list of :obj: `GenericEntry`): List of story arcs the Issue appears in.
        summary (str, Optional): Short description of the Issue.
        teams (list of :obj: `GenericEntry`): List of teams which appear in the Issue.
        teams_disbanded (list of :obj: `GenericEntry`): List of teams which disbanded in the Issue.
